# Template 2 of 6 — `task_assignment_full_hi`
...
विवरण: गोदाम रैक B में कॉटन लॉट 4521 के रोल गिनें और खराब पीस नोट करें
...
18. You are back at the template list. `task_assignment_full_hi` shows with status **In review** or **Pending**.
